// lab1_part2_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module lab1_part2_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> timer_0_s1_agent:cp_data
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> seven_seg_pio_s1_agent:cp_valid
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> seven_seg_pio_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // seven_seg_pio_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> seven_seg_pio_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> seven_seg_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> seven_seg_pio_s1_agent:cp_endofpacket
	...
	wire  [103:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire          seven_seg_pio_s1_agent_rp_valid;                                                    // seven_seg_pio_s1_agent:rp_valid -> router_007:sink_valid
	wire  [103:0] seven_seg_pio_s1_agent_rp_data;                                                     // seven_seg_pio_s1_agent:rp_data -> router_007:sink_data
	wire          seven_seg_pio_s1_agent_rp_ready;                                                    // router_007:sink_ready -> seven_seg_pio_s1_agent:rp_ready
	wire          seven_seg_pio_s1_agent_rp_startofpacket;                                            // seven_seg_pio_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          seven_seg_pio_s1_agent_rp_endofpacket;                                              // seven_seg_pio_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire    [6:0] router_005_src_channel;                                                             // router_005:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire    [6:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire          seven_seg_pio_s1_agent_rdata_fifo_src_valid;                                        // seven_seg_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] seven_seg_pio_s1_agent_rdata_fifo_src_data;                                         // seven_seg_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          seven_seg_pio_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> seven_seg_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> seven_seg_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> seven_seg_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // seven_seg_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> seven_seg_pio_s1_agent:rdata_fifo_sink_error
	...
	lab1_part2_mm_interconnect_0_router router (
	...
	lab1_part2_mm_interconnect_0_router_001 router_001 (
	...
	lab1_part2_mm_interconnect_0_router_002 router_002 (
	...
	lab1_part2_mm_interconnect_0_router_003 router_003 (
	...
	lab1_part2_mm_interconnect_0_router_002 router_004 (
	...
	lab1_part2_mm_interconnect_0_router_005 router_005 (
	...
	lab1_part2_mm_interconnect_0_router_002 router_006 (
	...
	lab1_part2_mm_interconnect_0_router_002 router_007 (
	...
	lab1_part2_mm_interconnect_0_router_002 router_008 (
	...
	lab1_part2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                   //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_part2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	lab1_part2_mm_interconnect_0_avalon_st_adapter_003 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
