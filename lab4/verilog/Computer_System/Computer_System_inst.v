	Computer_System u0 (
		...
		.fifo_out_read_req_pio_external_connection_export (<connected-to-fifo_out_read_req_pio_external_connection_export>), // fifo_out_read_req_pio_external_connection.export
		.fifo_in_write_req_pio_external_connection_export (<connected-to-fifo_in_write_req_pio_external_connection_export>), // fifo_in_write_req_pio_external_connection.export
		.fifo_in_full_pio_external_connection_export      (<connected-to-fifo_in_full_pio_external_connection_export>),      //      fifo_in_full_pio_external_connection.export
		.odata_pio_external_connection_export             (<connected-to-odata_pio_external_connection_export>),             //             odata_pio_external_connection.export
		.idata_pio_external_connection_export             (<connected-to-idata_pio_external_connection_export>),             //             idata_pio_external_connection.export
		.rle_reset_external_connection_export             (<connected-to-rle_reset_external_connection_export>),             //             rle_reset_external_connection.export
		.rle_flush_pio_external_connection_export         (<connected-to-rle_flush_pio_external_connection_export>),         //         rle_flush_pio_external_connection.export
		.result_ready_pio_external_connection_export      (<connected-to-result_ready_pio_external_connection_export>),      //      result_ready_pio_external_connection.export
